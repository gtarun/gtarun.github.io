...
export default function HeroCrystal() {
  return (
    ...
    >
      ...
      <div className="container-prose relative z-10 grid grid-cols-1 md:grid-cols-12 items-center gap-10 pt-16 pb-20 sm:pt-24 sm:pb-24">
        ...
        <motion.div
          ...
          className="md:col-span-5 relative h-[380px] sm:h-[460px] md:h-[540px]"
        >
          <CrystalScene />
        </motion.div>
      </div>
